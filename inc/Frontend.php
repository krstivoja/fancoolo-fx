...
class Frontend {
	...
	public static function inline_css() {
		...
		/* Reduce Motion: JS reveals never run (matchMedia gates on no-preference),
		   so lift the hidden state via CSS or the whole page stays invisible.
		   No !important — GSAP's inline visibility must still win when
		   respectReducedMotion is off and animations do run under reduce. */
